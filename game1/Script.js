...
window.onload = function () {
	...
	var url = "https://neto-web.github.io/game1/index.html";
	...
	//ぞう山くん画像
	var ZoyamaImg = "enemy.png";						//game.htmlからの相対パス
	...
	game.onload = function () {					//ロードが終わった後にこの関数が呼び出されるので、この関数内にゲームのプログラムを書こう
		...
		S_MAIN.backgroundColor = "green"; 			//S_MAINシーンの背景は黒くした
		...
		//ぞう山ボタン
		var Zoyama = new Sprite(280, 210);				//画像サイズをここに書く。使う予定の画像サイズはプロパティで見ておくこと
		...
		S_Tweet.ontouchend = function () {				//S_Tweetボタンをタッチした（タッチして離した）時にこの中の内容を実行する
			...
			window.open("http://twitter.com/intent/tweet?text=何とか" + Point + "体捕獲した" + url); //ハッシュタグにahogeタグ付くようにした。
		};
